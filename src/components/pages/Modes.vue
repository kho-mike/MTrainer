<template>
    <div class="content-other">
                <div class="content-other__header">
                    <div class="other-title">ВЫБОР РЕЖИМА ТРЕНИРОВКИ</div>
                    <div class="other-description">25 уровень</div>
                </div>
                        ...
                        <ul class="list-categories">
                            <li class="list-categories__item--medium">
                                <a href="#">
                                    ...
                                    <div class="list-categories__icon">
                                        <img src="@/assets/img/multiply2.png" height="120" alt="Умножение на 2">
                                    </div>
                            ...
                            <li class="list-categories__item--medium">
                                <a href="#">
                                    <div class="list-categories__rank">RANK</div>
                                    <div class="list-categories__icon">
                                        <img src="@/assets/img/multiply3.png" height="120" alt="Умножение на 3">
                                    </div>
                            ...
                            <li class="list-categories__item--medium">
                                <a href="#">
                                    <div class="list-categories__rank">RANK</div>
                                    <div class="list-categories__icon">
                                        <img src="@/assets/img/multiply4.png" height="120" alt="Умножение на 4">
                                    </div>
                            ...
                            <li class="list-categories__item--medium">
                                <a href="#">
                                    <div class="list-categories__rank">RANK</div>
                                    <div class="list-categories__icon">
                                        <img src="@/assets/img/multiply5.png" height="120" alt="Умножение на 5">
                                    </div>
                            ...
                            <li class="list-categories__item--medium">
                                <a href="#">
                                    <div class="list-categories__rank">RANK</div>
                                    <div class="list-categories__icon">
                                        <img src="@/assets/img/multiply6.png" height="120" alt="Умножение на 6">
                                    </div>
...
.btn:hover {
    box-shadow: 0 0 1rem rgba(116, 116, 116, 0.5);
}
...
.list-categories-box li {
    list-style-type: none;
    color: #F5F5F5;
    width: 33%;
}

.list-categories-box a {
    color: #F5F5F5;
}

.list-categories__rank {
    position: relative;
    top: 15%;
    left: 5%;
}
...
/* exercise-title
exercise-title__name
exercise-title__description
exercise-header__center
exercise-statistic
exercise-statistic__item
exercise-statistic__title
exercise-statistic__value
exercise-statistic__item
exercise-statistic__title
exercise-statistic__value
exercise-statistic__item
...
.exercise-content input, .exercise-content .btn {
    border: 0;
}

.exercise-content__task, .exercise-content__answer, .exercise-content__btn {
    text-align: center;
}
...
.answer--low-level, .answer--hight-level {
    padding: 1rem;
    margin: 1rem;
}
...
@media screen and (max-width: 650px) {
    ...
    .exercise-header__left, .exercise-header__center, .exercise-header__right {
